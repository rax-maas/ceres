...
public class DownsampleJobProcessorTest {
  ...
  @Test
  public void testDownsampleJobProcessor() throws InterruptedException {
    ...
    when(downsampleProcessor.processSet(any(PendingDownsampleSet.class), anyInt(), anyString(),
        anyString()))
